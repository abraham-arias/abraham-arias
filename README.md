# 👋 Hi, I'm Abraham Arias
**Aspiring IT Support Specialist | Help Desk | Desktop Support | Junior System Administrator**

I'm an entry-level IT professional with hands-on experience in Windows Server, Active Directory, Azure, networking, ticketing systems, and technical troubleshooting.  
I use this GitHub to document real-world IT labs, build small automation tools, and demonstrate the technical skills I bring to an IT Support or System Administrator role.
...
Ticketing systems (osTicket), troubleshooting, escalation, root-cause analysis, documentation, customer support

**Systems Administration:**  
Active Directory, Windows Server 2016–2022, Azure AD (basic), Group Policy, NTFS & share permissions, account provisioning

**Networking:**  
DNS, DHCP, TCP/IP, VPN, RDP, Wireshark, firewall/NSG rules, packet analysis

**Cloud & Tools:**  
Microsoft Azure, Virtual Machines, IIS, PowerShell (basic), virtualization

**Operating Systems:**  
Windows 10/11, Windows Server, Linux, macOS
...
- Python programming  
- Azure Administrator fundamentals  
- Endpoint management and device support  
- Troubleshooting methodologies used in Tier 1 & Tier 2 roles  

---

## 🎯 Career Goals
I'm pursuing IT Support, Help Desk, Desktop Support, and Junior System Administrator roles where I can grow my technical skills and help users solve real-world IT challenges.
